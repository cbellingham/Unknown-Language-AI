...
class Settings:
    ...
    max_audio_queue_frames: int = int(os.getenv("MAX_AUDIO_QUEUE_FRAMES", "120"))
    max_frame_queue: int = int(os.getenv("MAX_FRAME_QUEUE", "120"))
    max_utterance_queue: int = int(os.getenv("MAX_UTTERANCE_QUEUE", "16"))
